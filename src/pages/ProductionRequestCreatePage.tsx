...
export function ProductionRequestCreatePage() {
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-primary-500">
          Capture a gallery or collector enquiry — items get reference codes right away,
          artworks are only created once the confirmed order completes production.
        </p>
      </div>
