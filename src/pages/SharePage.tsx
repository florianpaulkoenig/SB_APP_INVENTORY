// ---------------------------------------------------------------------------
// NOA Inventory -- Public Share Download Page
// Standalone public page (no auth, no AppLayout) that renders the share
// download experience for a given token.
// ---------------------------------------------------------------------------

import { useParams } from 'react-router-dom';
import { ShareDownloadPage } from '../components/sharing/ShareDownloadPage';
...
export function SharePage() {
  ...
  // ---- Valid token -- render download page -----------------------------------

  return <ShareDownloadPage token={token} />;
}
