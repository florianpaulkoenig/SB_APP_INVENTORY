  ...
  async function exportPDF(withThumbnails: boolean) {
    ...
    try {
      ...
      const styles = StyleSheet.create({
        ...
        col: { flex: 1 },
        colRef: { width: 90, paddingRight: 4 },
        colTitle: { flex: 1, paddingRight: 8 },
        colYear: { width: 30, textAlign: 'center', paddingRight: 4 },
        colPrice: { width: 70, textAlign: 'right', paddingRight: 2 },
        colDate: { width: 76, paddingLeft: 8 },
        colGain: { width: 54, textAlign: 'right', paddingLeft: 8 },
