  ...
  return (
    <div className="space-y-8">
      ...
      <section className="rounded-lg border border-primary-100 bg-white p-6">
        ...
        {Boolean((artwork as Record<string, unknown>).is_window) && (
          <div className="mt-4 flex flex-wrap items-center gap-2">
            <span className="inline-flex items-center rounded-full bg-blue-50 px-2.5 py-0.5 text-xs font-medium text-blue-700">
              Window Artwork
            </span>
            {Boolean((artwork as Record<string, unknown>).lamination_needed) && (
              <>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <Select
              ...
              options={[...CURRENCIES]}
              value={saleCurrency}
              onChange={(e) => setSaleCurrency(e.target.value as 'EUR' | 'USD' | 'CHF' | 'GBP')}
            />
          </div>
          <Input
            label="Sale Date"
