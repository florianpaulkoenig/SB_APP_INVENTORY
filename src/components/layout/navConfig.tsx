...
// ---------------------------------------------------------------------------
// Shared navigation config — the single source of truth consumed by BOTH the
// desktop Sidebar and the mobile MobileNav so the two never drift apart.
// ---------------------------------------------------------------------------
...
export const noaCurationNavSections: NavSection[] = [
  {
    title: 'INVENTORY',
    items: [
      { label: 'Artworks', to: '/artworks', icon: icons.artworks, roles: ['admin'] },
...
export const noaLiquidityNavSections: NavSection[] = [
  {
    title: 'FINANCE',
    items: [
      { label: 'Liquidity', to: '/liquidity', icon: liquidityIcon, roles: ['admin'] },
...
// Sidebar component
// ---------------------------------------------------------------------------
export const PORTFOLIO_LABELS: Record<Portfolio, { name: string; sub: string }> = {
...
// Pick the nav sections for the active portfolio.
export function getNavSections(portfolio: Portfolio): NavSection[] {
  switch (portfolio) {
    case 'noa_collection': return noaNavSections;
    case 'noa_curation': return noaCurationNavSections;
    case 'noa_liquidity': return noaLiquidityNavSections;
    default: return navSections;
  }
}
