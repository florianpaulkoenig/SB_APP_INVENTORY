...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Commission Dashboard', to: '/analytics/commission-dashboard', icon: icons.invoices, roles: ['admin'] },
      { label: 'Institutional Strategy', to: '/analytics/institutional-strategy', icon: icons.collections, roles: ['admin'] },
      { label: 'Viewing Room Analytics', to: '/analytics/viewing-room-analytics', icon: icons.viewingRooms, roles: ['admin'] },
      { label: 'Media Impact', to: '/analytics/media-impact', icon: icons.catalogue, roles: ['admin'] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Marketing Kit', to: '/gallery/marketing', icon: icons.catalogue, roles: ['gallery'] },
